...
flags.DEFINE_integer(
    "aerospike_client_vms", 1, "Number of client machines to use for running asbench."
)
flags.DEFINE_integer(
...
flags.DEFINE_integer(
    "aerospike_benchmark_duration", 60, "Duration of each test iteration in secs."
)
...
def Run(benchmark_spec):
    ...
    for threads in range(
        ...
        def _Run(client_idx, process_idx):
            ...
            stdout_samples.extend(
                aerospike_client.ParseAsbenchStdout(stdout)
